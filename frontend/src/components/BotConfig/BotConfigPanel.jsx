...
const s = {
  wrap:        { fontFamily: "'Inter', system-ui, sans-serif", maxWidth: 1160, margin: "0 auto",
                 padding: "1.25rem 1rem", color: "var(--db-text-strong)" },
  header:      { display: "flex", justifyContent: "space-between", alignItems: "flex-start",
                 marginBottom: "1rem", flexWrap: "wrap", gap: 10 },
  title:       { fontSize: 18, fontWeight: 700, margin: 0 },
  sub:         { fontSize: 13, color: "var(--db-text-muted)", margin: "3px 0 0" },
  cols:        { display: "grid", gridTemplateColumns: "1fr 360px", gap: 12, alignItems: "start" },
  card:        { background: "var(--db-card-bg)", border: "1px solid var(--db-card-border)", borderRadius: 12, padding: "1rem 1.1rem" },
  cardHeader:  { display: "flex", gap: 10, alignItems: "flex-start", marginBottom: "0.75rem" },
  iconBox:     { width: 30, height: 30, borderRadius: 7, background: "var(--ts-icon-bg)",
                 display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 },
  cardTitle:   { fontSize: 14, fontWeight: 600, color: "var(--db-text-strong)" },
  cardSub:     { fontSize: 11, color: "var(--db-text-muted)", marginTop: 2, lineHeight: 1.5 },
  code:        { background: "var(--ts-icon-bg)", padding: "1px 5px", borderRadius: 3,
                 fontSize: 10, fontFamily: "monospace", color: "var(--db-text-subtle)" },
  hint:        { fontSize: 11, color: "var(--db-text-muted)" },
  bigTextarea: { width: "100%", fontSize: 13, padding: "10px 12px", border: "1px solid var(--ts-input-border)",
                 borderRadius: 8, color: "var(--db-text-strong)", background: "var(--ts-input-bg)", resize: "vertical",
  ...
  input:       { width: "100%", fontSize: 13, padding: "8px 10px", border: "1px solid var(--ts-input-border)",
                 borderRadius: 7, color: "var(--db-text-strong)", background: "var(--ts-input-bg)", outline: "none",
                 boxSizing: "border-box" },
  label:       { display: "block", fontSize: 12, fontWeight: 500, color: "var(--db-text-subtle)", marginBottom: 5 },
