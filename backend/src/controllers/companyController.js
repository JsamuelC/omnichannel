  ...
  try {
    ...
    try {
      ...
      await sendWelcomeEmail({
        toEmail:          admin_email.toLowerCase(),
        userName:         admin_name || `Admin ${nombre}`,
        companyName:      nombre,
        password:         admin_password,
        verificationCode: adminUser.email_verification_code || '000000',
      });
    } catch (e) { logger.warn('Error enviando email de bienvenida:', e.message); }
